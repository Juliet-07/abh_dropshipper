  ...
  return (
    <>
      ...
      {showPreview && (
        <div
          // onClick={()=> setPreview(false)}
          className="w-full h-[100vh] justify-center bg-[#000000a8] fixed top-0 left-0 flex flex-col items-center "
        >
          <div className="w-[90%] max-w-[562px] relative  bg-white rounded-[10px] p-[20px] md:p-[40px] my-[5vh]">
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="w-full flex flex-row">
                <b className="min-w-[130px] text-[16px]">Discount type - </b> <p>Fixed</p>
              </div>
              <div className="w-full flex flex-row">
                <b className="min-w-[130px] text-[16px]">Value</b> <p>100</p>
              </div>
              <div className="w-full flex flex-row">
                <b className="min-w-[130px] text-[16px]">Applies to - </b> <p>All Products</p>
              </div>
            
              <div className="w-full flex flex-row">
                <b className="min-w-[130px] text-[16px]">Period - </b> <p>june 11,2024- July 11, 2024</p>
              </div>
              <div className="w-full flex flex-row">
                <b className="min-w-[130px] text-[16px]">Status - </b>  <div className="min-w-[66px] h-[35px] bg-[#088D2D1F] p-[10px] flex flex-row items-center justify-center gap-[10px]">
